				...
				<div class="flex mt-1 mb-2">
					<div in:fade={{ duration: 100, delay: 50 }}>
						{#if models[selectedModelIdx]?.info?.meta?.description ?? null}
							...
							>
								<div
									class="expert-agent-subtitle mt-1 w-full max-w-[42rem] break-words px-2 text-[1.75rem] @sm:text-[1.875rem] @4xl:max-w-[64rem] @4xl:text-[2rem] leading-tight text-[#66748c] dark:text-gray-300 line-clamp-2 markdown"
								>
