...
HERMES_EXPERT_AGENT_SKILLS_DIR = os.environ.get('HERMES_EXPERT_AGENT_SKILLS_DIR', '').strip()
HERMES_EXPERT_AGENT_HIDDEN_SKILLS = os.environ.get('HERMES_EXPERT_AGENT_HIDDEN_SKILLS', '').strip()
HERMES_EXPERT_AGENT_VISIBLE_SKILLS = os.environ.get('HERMES_EXPERT_AGENT_VISIBLE_SKILLS', '').strip()
